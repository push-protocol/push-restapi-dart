...
enum EncryptionType { PGP_V1, PGP_V2, PGP_V3, NFTPGP_V1 }

extension Enc on EncryptionType {
  String get value {
    switch (this) {
      case EncryptionType.PGP_V1:
        return ENCRYPTION_TYPE.PGP_V1;
      case EncryptionType.PGP_V2:
        return ENCRYPTION_TYPE.PGP_V2;
      case EncryptionType.PGP_V3:
        return ENCRYPTION_TYPE.PGP_V3;
      case EncryptionType.NFTPGP_V1:
        return ENCRYPTION_TYPE.NFTPGP_V1;
    }
  }
}
...
class CHAT {
  ...
  static const String META_SPACE_LISTENER_REQUEST_MIC_REJECT =
      'LISTENER_REQUEST_MIC_REJECT';
  static const String META_SPACE_LISTENER_PROMOTE_INVITE =
      'PROMOTE_LISTENER_INVITE';
  ...
  static const String UA_LISTENER_ACCEPT_PROMOTION_INVITE =
      'LISTENER_ACCEPT_PROMOTION_INVITE';
  static const String UA_LISTENER_REJECT_PROMOTION_INVITE =
      'LISTENER_REJECT_PROMOTION_INVITE';
