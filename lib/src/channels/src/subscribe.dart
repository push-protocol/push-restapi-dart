...
Future<Map<String, dynamic>> subscribe(SubscribeOptionsType options) async {
  try {
    ...
    final typeInformation = getTypeInformation(ChannelActionType.subscribe);
